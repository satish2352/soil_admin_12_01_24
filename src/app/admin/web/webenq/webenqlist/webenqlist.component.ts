...
export class WebenqlistComponent implements OnInit {
  ...
  // 0"id": 14,
  // 1"name": "ajay gaikwad",
  // 2"email": "ajay@gmail.com",
  // 3"mobile": "7845121245fdfgdsgsd",
  // 4"details": "Super Soil Charger,Super Fruit Charger,Super Flower Charger,Super Size Charger,Super Crop Charger",
  // 5"comment": "test 5",
  // 6"is_deleted": "no",
  // "created_by": "2024-02-29 10:36:48",
  // "updated_at": "2024-02-29 10:36:48"
  ...
  async exportToPdf() {
    ...
    if (tableElement) {
      ...
      const documentDefinition = {
        ...
        content: [
          { text: 'Website Enq List', style: 'header' },
          {
            table: {
              headerRows: 1,
