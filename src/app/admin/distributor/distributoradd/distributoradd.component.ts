...
@Component({
  ...
  styleUrls: ['./distributoradd.component.css']
})
export class DistributoraddComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formGroupNew = new FormGroup({
      ...
      // aadharcard: new FormControl('785786889467', [Validators.required, Validators.minLength(12), Validators.maxLength(12),Validators.pattern('^[0-9]{12}$')]),
      ...
      exp_in_agricultural: new FormControl('2', [Validators.required]),
